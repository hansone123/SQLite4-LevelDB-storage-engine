...
LIBOBJ+= vdbe.o parse.o \
         ...
         icu.o insert.o kv.o kvlsm.o kvldb.o kvmem.o legacy.o \
...
sqlite4$(EXE):	$(TOP)/src/shell.c libsqlite4.a sqlite4.h
	$(TCCX) $(READLINE_FLAGS) -o sqlite4$(EXE)                  \
		$(TOP)/src/shell.c                                  \
		libsqlite4.a $(LIBREADLINE) $(TLIBS) $(THREADLIB) -lleveldb
...
%.o:	$(TOP)/src/%.c $(HDR)
	$(TCCX) -c $<
#kvldb.o:	$(TOP)/src/kvldb.c $(HDR)
#	$(TCCX) $(TOP)/src/kvldb.c -lleveldb

#env.o:	$(TOP)/src/env.c $(HDR)
#	$(TCCX2) -c $(TOP)/src/env.c
